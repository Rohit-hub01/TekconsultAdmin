...
const ConsultantSettings = () => {
    ...
    const [sessionRequestNotif, setSessionRequestNotif] = useState(true);
            ...
            <div className="px-6 py-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <section className="space-y-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <SettingItem
                            icon={Bell}
                            label="Session Request Alerts"
                            description="Notify when users request sessions"
                            type="switch"
                            action={{ value: sessionRequestNotif, onChange: setSessionRequestNotif }}
                        />
                        <SettingItem
                            icon={DollarSign}
                            ...
                            type="switch"
                            action={{ value: earningsNotif, onChange: setEarningsNotif }}
                        />
                    </div>
                </section>
                        ...
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                    ...
                                    consultant account and remove your data from our servers.
                                </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
