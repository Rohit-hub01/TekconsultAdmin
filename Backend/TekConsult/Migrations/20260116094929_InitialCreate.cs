        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChatRatePerMinute = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CallRatePerMinute = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IsOnline = table.Column<bool>(type: "bit", nullable: false),
                    FreeMinutesOffer = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalChargedAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ConsultantEarnings = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BankDetailsSnapshot = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConsultantCategories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConsultantCategories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "CategoryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ConsultantCategories_ConsultantProfiles_ConsultantProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_KYCDocuments_ConsultantProfiles_ConsultantProfileId",
                        column: x => x.ConsultantProfileId,
                        principalTable: "ConsultantProfiles",
                        principalColumn: "ConsultantProfileId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_ConsultationSessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "ConsultationSessions",
                        principalColumn: "SessionId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "SessionBillingTicks",
                columns: table => new
                {
                    TickId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SessionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AmountDeducted = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BalanceAfterDeduction = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Timestamp = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionBillingTicks", x => x.TickId);
                    table.ForeignKey(
                        name: "FK_SessionBillingTicks_ConsultationSessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "ConsultationSessions",
                        principalColumn: "SessionId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsultantCategories_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KYCDocuments_ConsultantProfileId",
                table: "KYCDocuments",
                column: "ConsultantProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionBillingTicks_SessionId",
                table: "SessionBillingTicks",
                column: "SessionId");
